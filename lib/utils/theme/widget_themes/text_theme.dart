...
class TTextTheme {
  ...
  /// Caracteristicas Light Text Theme
  static TextTheme lightTextTheme = TextTheme(
    ...
    titleSmall: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w400, color: Colors.black),
  ...
  /// Caracteristicas Dark Text Theme
